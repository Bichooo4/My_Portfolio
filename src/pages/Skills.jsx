        ...
        {isMobile && (
          ...
          >
            <div className="relative">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-lime-500 to-emerald-500 rounded-lg blur opacity-25" />
              <div className="relative h-24 bg-gray-900 rounded-lg border border-gray-800 shadow-xl p-4">
